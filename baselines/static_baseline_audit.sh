...
if "${SEARCH_CMD[@]}" "inference/generate_images.py|generate_concept_ablation_images.py" \
...
"${SEARCH_CMD[@]}" "uce-|concept_ablation-|results/uce|results/concept_ablation_compvis" baselines README.md evaluation/evaluate.py evaluation/make_comparison_grids.py
