...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description=(
            "Train SPACE for SD v1.4: localized artist-style erasure with "
    ...
    parser.add_argument("--progress_dir", type=str, default=None, help="directory for durable JSONL metrics and snapshots")
    parser.add_argument("--checkpoint_interval", type=int, default=50, help="save an intermediate SPACE snapshot every N steps; 0 disables")
    parser.add_argument("--wandb_project", type=str, default=None, help="optional W&B project")
    parser.add_argument("--wandb_run_id", type=str, default=None, help="stable W&B run id for resume=allow")
...
def main() -> None:
    ...
    from core.space_trainer import SPACEConfig, run_space_training
