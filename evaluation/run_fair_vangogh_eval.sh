...
METHOD_KEYS="${METHOD_KEYS:-esd,uce,ca,space}"
FID_METHOD_KEYS="${FID_METHOD_KEYS:-esd,uce,space}"
GRID_METHODS="${GRID_METHODS:-ESD-x,UCE,CA,SPACE}"
...
fid_dirs = {"esd": "erased", "uce": "uce", "space": "space"}
...
"$PYTHON_BIN" evaluation/make_comparison_grids.py \
  --only-artist "Van Gogh" \
